...
export default {
  ...
  data() {
    return {
      ...
      dataList: [
        {
          image: require('@/assets/home/livingRoom.jpg'),
          tipsList: [
            {
        ...
        {
          image: require('@/assets/home/kitchen.jpg'),
          tipsList: [
            {
  ...
  methods: {
    ...
    addTipsSprite(index = 0) {
      let tipTexture = new THREE.TextureLoader().load(require('@/assets/home/tip.png'))
    ...
    onMousemove(e) {
      ...
      if (intersects.length > 0) {
        ...
        if (intersects[0].object.content.showTip) {
          let left = Math.round(elementWidth * position.x + elementWidth - this.$refs.tooltipBox.clientWidth / 2)
          let top = Math.round(-elementHeight * position.y + elementHeight - this.$refs.tooltipBox.clientHeight / 2)
          this.tooltipPosition = {
            left: `${left}px`,
            top: `${top}px`
          }
        } else if (intersects[0].object.content.showTitle) {
          let left = Math.round(elementWidth * position.x + elementWidth - this.$refs.titleBox.clientWidth / 2)
