import { AmbientLight, DirectionalLight, FogExp2, PointLight } from 'three'
  ...
  animate() {
    ...
    if (Math.random() > 0.93 || this.lightning.power > 100) {
      if (this.lightning.power < 100) {
        this.lightning.position.set(Math.random() * 400, 300 + Math.random() * 200, 100)
      }
