import { PointsMaterial, BufferGeometry, Float32BufferAttribute, Points, TextureLoader, AdditiveBlending } from 'three'

export default class RainDrop {
  constructor() {
    const texture = new TextureLoader().load(require('@/assets/rain/rain-drop.png'))
